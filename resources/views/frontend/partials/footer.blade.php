            ...
            <div class="row g-md-4 gy-sm-5 gy-2">
                ...
                <div class="col-xxl-2 col-xl-4 col-sm-6">
                    ...
                    <ul class="footer-list footer-contact mb-sm-0 mb-3">
                        ...
                        <li>
                            <a href="blog-#" class="footer-contain-2">
                ...
                <div class="col-xxl-2 col-xl-4 col-sm-6">
                    ...
                    <ul class="footer-list footer-contact mb-sm-0 mb-3">
                        <li>
                            <a href="order-#" class="footer-contain-2">
                                <i class="fas fa-angle-right"></i>Your Order</a>
                        </li>
                        <li>
                            <a href="user-#" class="footer-contain-2">
                ...
                <div class="col-xxl-2 col-xl-4 col-sm-6">
                    ...
                    <ul class="footer-list footer-contact mb-sm-0 mb-3">
                        <li>
                            <a href="#" class="footer-contain-2">
                                <i class="fas fa-angle-right"></i>Men's and Boy's Fashion</a>
                        </li>
                        <li>
                            <a href="#" class="footer-contain-2">
                                <i class="fas fa-angle-right"></i>Women's and Girl's Fashion</a>
                        </li>
                        <li>
                            <a href="#" class="footer-contain-2">
                                <i class="fas fa-angle-right"></i>Boys' Fashion</a>
                        </li>
                        <li>
                            <a href="#" class="footer-contain-2">
                                <i class="fas fa-angle-right"></i>Girl's Fashion</a>
                        </li>
                    </ul>
                </div>
                        ...
                        <li>
                            <a href="javascript:void(0)">
                                <div class="inform-box flex-start-box">
                                    ...
                                    <p>{{ env('APP_NAME') }} Demo Store, Demo store Demo 345 - 659</p>
                                </div>
                            </a>
                        </li>
                ...
                <div class="row g-sm-4 g-2">
                    <div class="col-lg-6">
                        <div class="slider-image">
                            <img src="" class="img-fluid blur-up lazyload modal-product-image"
                                alt="image">
                        </div>
                    </div>
                        ...
                        <div class="right-sidebar-modal">
                            ...
                            <ul class="brand-list">
                                <li>
                                    <div class="brand-box">
                                        <h5>Brand Name:</h5>
                                        <h6 class="modal-product-brand"></h6>
                                    </div>
                                </li>
                                <li>
                                    <div class="brand-box">
                                        <h5>Product Type:</h5>
                                        <h6 class="modal-product-type"></h6>
                                    </div>
                                </li>
                            </ul>
                            ...
                            <div class="modal-button" data-product-id="">
                                <button class="btn btn-md add-cart-button icon">Add
                                    To Cart</button>
...
<script>
    $(document).ready(function() {
        ...
        $('#logout-btn').click(function() {
            $.ajax({
                url: "/logout", // URL to send the POST request
                type: "POST",
            ...
            var listItem = $(
                ...
                <div class="drop-cart">\
                    ...
                    <div class="drop-contain">\
                        <a href="javascript:void(0)" data-slug="' + slug + '">\
                            <h5 class="cart-product-title">' + product_name + '</h5>\
                        </a>\
    ...
    // add to cart ajax fn
    function callAddToCart(id, qty, type = "ADD", view = null) {
        $.ajax({
            ...
            success: function(response) {
                if (type == "ADD") {
                    ...
                    element.parent('.drop-cart').find('.cart-product-price span').text(
                        response.cart.quantity +
                        ' x ');
                } else {
