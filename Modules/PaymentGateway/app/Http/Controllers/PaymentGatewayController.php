...
class PaymentGatewayController extends Controller
{
    ...
    public function razorpay_update(Request $request)
    {
        ...
        if ($request->file('razorpay_image')) {
            ...
            $file_name = file_upload($request->razorpay_image, $razorpay_setting->value, 'uploads/custom-images/');
    ...
    public function flutterwave_update(Request $request)
    {
        ...
        if ($request->file('flutterwave_image')) {
            ...
            $file_name = file_upload($request->flutterwave_image, $flutterwave_setting->value, 'uploads/custom-images/');
    ...
    public function paystack_update(Request $request)
    {
        ...
        if ($request->file('paystack_image')) {
            ...
            $file_name = file_upload($request->paystack_image, $paystack_setting->value, 'uploads/custom-images/');
    ...
    public function mollie_update(Request $request)
    {
        ...
        if ($request->file('mollie_image')) {
            ...
            $file_name = file_upload($request->mollie_image, $mollie_setting->value, 'uploads/custom-images/');
    ...
    public function instamojo_update(Request $request)
    {
        ...
        if ($request->file('instamojo_image')) {
            ...
            $file_name = file_upload($request->instamojo_image, $instamojo_setting->value, 'uploads/custom-images/');
