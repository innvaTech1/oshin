...
<li
    class="nav-item dropdown {{ Route::is('admin.product.*') || Route::is('admin.unit*') || Route::is('admin.category*') || Route::is('admin.brand*') || Route::is('admin.attribute*') || Route::is('admin.product.inventory') || Route::is('admin.product.import') ? 'active' : '' }}">
